...
const features = [
    {
        ...
        description: "Our proprietary AI system processes 500 trillion operations per second. It thinks, learns, and evolves with you, enabling true Level 5 autonomy.",
        color: "text-blue-500",
    ...
    },
    {
        ...
        description: "Seamless integration with smart cities and V2X communication. Your Aether vehicle communicates with infrastructure and other vehicles to optimize traffic.",
...
const stats = [
    { number: 500, suffix: "+", label: "Patents Filed" },
    { number: 0, suffix: "%", label: "Carbon Emissions" },
    { number: 24, suffix: "/7", label: "AI Monitoring" },
    { number: 100, suffix: "%", label: "Recyclable" }
];
        ...
        <div ref={containerRef} className="bg-black min-h-screen text-white overflow-hidden">
            <div className="relative h-screen flex items-center justify-center overflow-hidden">
                <motion.div style={{ y }} className="absolute inset-0 z-0">
                    <img src={techBg} alt="Future Technology" className="w-full h-full object-cover opacity-60" />
                ...
                <div className="relative z-10 container text-center px-4">
                    ...
                    <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5, duration: 0.8 }} className="text-xl md:text-2xl text-blue-400 font-light tracking-widest uppercase">
            ...
            <div className="relative z-10 bg-black">
                <div className="container py-32 space-y-32">
                    {features.map((feat, idx) => (
                        <FeatureSection key={feat.title} {...feat} align={idx % 2 === 0 ? 'left' : 'right'} />
                    ))}
                </div>
                ...
                <div className="mt-24 py-32 border-t border-white/10 bg-zinc-900/30 backdrop-blur-sm relative overflow-hidden">
                    ...
                    <div className="container relative z-10">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
                            {stats.map((stat, idx) => (
                                <Stat key={stat.label} {...stat} delay={idx * 0.2} />
                            ))}
                        </div>
                    </div>
                </div>
...
function Stat({ number, suffix, label, delay }) {
    return (
        <div className="text-center group cursor-default">
            <motion.div initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay }} viewport={{ once: true }} className="relative inline-block">
