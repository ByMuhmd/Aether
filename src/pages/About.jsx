...
const timeline = [
    { year: "2015", title: "The Beginning", description: "Aether was founded with a simple sketch and a dream." },
    { year: "2018", title: "First Prototype", description: "The Alpha prototype shattered speed records and expectations." },
    { year: "2021", title: "Global Launch", description: "We delivered our first vehicle, marking a new era in automotive history." },
    { year: "2025", title: "The Future", description: "Expanding our lineup and redefining what a car company can be." }
];
        ...
        <div className="bg-black min-h-screen text-white">
            <div className="relative h-[70vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 container text-center">
                    <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-6xl md:text-8xl font-bold mb-6">
                        Our Vision
                    </motion.h1>
                    <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
                    ...
                    <div className="flex justify-center">
                        <div className="max-w-sm group">
                            <div className="aspect-[3/4] rounded-2xl overflow-hidden mb-6 relative">
                                <img src={ceoImg} alt="Elena Vance" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
